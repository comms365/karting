...
class UserSiteSessionsControllerTest < ActionController::TestCase
  ...
  test "should create user_site_session" do
    assert_difference('UserSiteSession.count') do
      post :create, user_site_session: { lap_time: @user_site_session.lap_time, session_date: @user_site_session.session_date, weather: @user_site_session.weather }
    end
  ...
  test "should update user_site_session" do
    patch :update, id: @user_site_session, user_site_session: { lap_time: @user_site_session.lap_time, session_date: @user_site_session.session_date, weather: @user_site_session.weather }
    assert_redirected_to user_site_session_path(assigns(:user_site_session))
  end
